...
if __name__ == '__main__':
  ...
  usage += 'Tips: \n'
  #usage += '     Define the following files in the <ch1.cat>:  imgfile, rmsfile, psffile, catfile\n'
  usage += "     (1) search  photometry.cat 2 3  206.90479  -11.75055  0.005  | awk '{printf \"%f  %f    %f\\n\",$2,$3,$110}'    > input.cat \n" 
  usage += "     (2) convertxy input.cat 1 2 img.fits \n" 
  usage += "     (3) rungalfit input.cat \n"
