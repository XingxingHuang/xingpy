...
def cipphot(files, filts, lamdict, nexposures, outdir, sexdir, detdir, cipdir, field, datestr, pixelscale=0.065, forcesec=True, forcetot=False, doapcor=True, eBV=None):
...
""" % (fieldv, datestr2, eBV)
    ...
    outname = 'photometry.cat'
    if not doapcor:
        outname = 'photometry_noapcor.cat'
