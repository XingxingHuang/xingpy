...
print,'function add_tag,struct,tag_value,tag_name,index=index,err=err,$'
print,'          duplicate=duplicate,top_level=top_level,no_copy=no_copy,$'
print,'          quiet=quiet,_extra=extra,name=name,no_pair=no_pair'
return,-1
endif
